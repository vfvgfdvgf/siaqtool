...
export const metadata: Metadata = { title: "مسارات العمل", description: "وصفات جاهزة تجمع أدوات سياق لإنجاز مهام الملفات متعددة الخطوات." };
const workflows = [
