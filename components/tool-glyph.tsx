...
const glyphs: Record<string, LucideIcon> = {
  ...
  "extract-text-pdf": TextCursorInput, "pdf-info": FileText, "pdf-to-json": Braces,
  "extract-images-pdf": FileImage, "odd-pages-pdf": FileOutput, "even-pages-pdf": FileOutput,
  "first-page-pdf": FileOutput, "last-page-pdf": FileOutput, "interleave-pdf": Files,
  "remove-blank-pages": Scissors, "add-page-border": FormInput, "resize-pdf-a4": Crop,
  "two-up-pdf": Files,
  ...
  "json-to-excel": FileSpreadsheet, "excel-to-json": Braces, "merge-csv": Files,
  "split-csv": Scissors, "deduplicate-csv": ListFilter, "csv-summary": Table2,
  "markdown-to-docx": FileText, "docx-to-html": Braces, "xlsx-to-html": Braces,
  "powerpoint-to-images": FileImage,
  ...
  "invert-image": ImageIcon, "sepia-image": WandSparkles, "auto-contrast-image": Sparkles,
  "equalize-image": ImageIcon, "brightness-image": Sparkles, "contrast-image": ImageIcon,
  "posterize-image": WandSparkles, "image-border": ImagePlus, "square-image": Crop,
  "image-palette": ImageIcon, "compare-images": ArrowLeftRight, "png-to-bmp": FileImage,
  "bmp-to-png": ImageIcon, "tiff-to-png": ImageIcon, "gif-to-png": ImageIcon,
  "avif-to-png": ImageIcon, "ico-to-png": ImageIcon, "heic-to-webp": ImageIcon,
  ...
  "csv-to-json": Braces, "json-to-csv": Table2, "csv-to-tsv": Table2,
  "tsv-to-csv": Table2, "text-to-pdf": FileOutput,
